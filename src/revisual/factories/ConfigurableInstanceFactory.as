...
public class ConfigurableInstanceFactory implements ICreatable {

    private var _item:Object;
    private var _key:Object;

    public function ConfigurableInstanceFactory( item:Object, key:Object ) {
     ...
     private function getProduct( equals:Boolean ):IProduct{
        return ( equals ) ? new Product( _item ) : new Product( null );
    }
}
}
